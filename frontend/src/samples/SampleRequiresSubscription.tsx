  ...
  const handlePageLoad = async () => {
    ...
    try {
      const response = await fetch(
        "/api/v1/owner/get-protected-data-subscriptions-any",
        {
          method: "GET",
          headers: {
      ...
      if (response.status === 403) {
        ...
        alert(
          "Failed to get data, are you sure you have your stripe environment setup correctly with product codes in the samples API endpoint."
        );
      }
    } catch (err) {
  ...
  return (
    ...
    isLoading ? (
      ...
      <div className="max-w-md mx-auto mt-10 p-6 bg-base-100 rounded-lg">
        ...
        <p className="mb-4">
          If you are not subscribed, you will see a purchase button.
        </p>
        {error && (
        ...
        {showPurchaseOption && (
          <div className="mt-4">
            <p className="mb-2">
              You need to purchase this subscription to access this page.
            </p>
            <button
...

        {
          ...
          protectedData && (
            <div className="mt-4 alert alert-success">
              ...
              <p>
                You have a subscription! Here is a message from the server: [
